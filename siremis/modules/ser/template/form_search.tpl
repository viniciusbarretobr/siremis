...
<div style="padding-left:25px; ">
	...
	<div style="padding-left:0px;">
		<h2><a id="{$form.name}_content_toggler" href="#" class="shrink" onclick="toggleDisplay('{$form.name}_content');"></a>Search</h2>
		<div id="{$form.name}_content" style="display:block;padding-left:10px;">
		<div class="" style="height:160px;">			
			{foreach name=itemIndex item=item key=itemName from=$dataPanel}
				{if $item.elementset eq "General"}			
					{if $smarty.foreach.itemIndex.index is odd}
