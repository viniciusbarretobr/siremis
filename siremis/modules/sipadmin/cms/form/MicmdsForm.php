<?php
include_once (MODULE_PATH.'/sipadmin/service/asipto/libs/cmds/sermi.php');
include_once (MODULE_PATH.'/sipadmin/service/siremisMICommands.php');

class MicmdsForm extends EasyForm 
{ 
   	protected $localService = "sipadmin.service.siremisMICommands";
